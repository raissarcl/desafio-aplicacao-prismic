...
/**
 * Primary content in A → Primary
 *
 */
interface AaaSliceDefaultPrimary {
    /**
     * Title field in *A → Primary*
     *
     * - **Field Type**: Title
     * - **Placeholder**: This is where it all begins...
     * - **API ID Path**: aaa.primary.title
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    title: prismicT.TitleField;
    /**
     * Description field in *A → Primary*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: A nice description of your feature
     * - **API ID Path**: aaa.primary.description
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
 ...
 *
 */
export type AaaSliceDefault = prismicT.SharedSliceVariation<"default", Simplify<AaaSliceDefaultPrimary>, never>;
/**
 * Slice variation for *A*
 *
 */
type AaaSliceVariation = AaaSliceDefault;
/**
 * A Shared Slice
 *
 * - **API ID**: `aaa`
 ...
 *
 */
export type AaaSlice = prismicT.SharedSlice<"aaa", AaaSliceVariation>;
declare module "@prismicio/client" {
    interface CreateClient {
        (repositoryNameOrEndpoint: string, options?: prismic.ClientConfig): prismic.Client<AllDocumentTypes>;
    }
    namespace Content {
        export type { PostsDocumentData, PostsDocumentDataContentItem, PostsDocumentDataSlicesSlice, PostsDocument, AllDocumentTypes, AaaSliceDefaultPrimary, AaaSliceDefault, AaaSliceVariation, AaaSlice };
    }
}
